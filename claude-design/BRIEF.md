...
> **Source screenshots:** `./screenshots/raw_*.png` (iPhone 17 Pro, 1206 × 2622, light-mode UI).
...
| File | What it is |
|---|---|
| `reference/STATSCOUT_SAVANT_HANDOFF.md` | In-app design system spec — palette, type, module definitions |
| `reference/SAVANT_PLAYER_PAGE_REFERENCE.html` | High-fidelity HTML mock of the player-page aesthetic |
| `reference/design-brief-for-claude-design.md` | Broader product/design context |
| `screenshots/raw_*.png` | Source screenshots for the 8 frames |
