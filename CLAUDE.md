...
**App Store reviews:** StatScout uses the enjoyment funnel in `StatScout/Services/ReviewPromptTracker.swift` (passive triggers: 3rd+ player profile open, Pro player comparison). Playbook: `~/Desktop/app-store-5-star-review-strategy.md`. App Store ID `6743780853`; feedback `jackwallner+bb@gmail.com`.
