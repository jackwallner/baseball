"""
Backfill all historical years (2015-2025) with enhanced actual values.

Usage:
    python backend/backfill_all_years.py
"""
...
def main():
    ...
    # Years to backfill (2015 to current, but skip 2025-2026 as they're already done)
    years = list(range(2015, 2025))  # 2015-2024
    
    logger.info("=" * 70)
    logger.info("BACKFILLING ALL HISTORICAL YEARS: %s", years)
    logger.info("=" * 70)
    ...
    for season in years:
        ...
        try:
            # Override season for build_snapshot_rows
    ...
    logger.info("=" * 70)
    logger.info("Total players across all years: %d", total_players)
